...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Сowboy') }}</title>
        ...
        <style>
            ...
            footer {
            width: 100%;
            max-width: 800px; /* Робимо ширину такою ж, як у 'main' */
            margin: 20px auto;
            padding-top: 20px;
            border-top: 1px solid #e5e5e5; /* Лінія-роздільник */
            text-align: center;
            font-family: 'Instrument Sans', sans-serif;
            color: #555;
            font-size: 0.9em;
            ...
            .tech-logos {
                display: flex; /* Розміщуємо логотипи в ряд */
                justify-content: center; /* Центруємо їх */
                align-items: center;
                gap: 25px; /* Відстань між логотипами */
            }

            .tech-logos img {
                height: 35px; /* Фіксована висота для логотипів */
                opacity: 0.8;
                transition: opacity 0.2s ease;
            }

            .tech-logos a:hover img {
                opacity: 1; /* Ефект при наведенні */
            }
        </style>
    </head>
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main>
                <div>
                    ...
                    <div>
                        <img src="https://i0.wp.com/duesouth.media/wp-content/uploads/2023/02/urban-cowboy.png?w=1000&ssl=1" alt="Urban Cowboy" class="object-cover w-full h-full">
                    </div>
                    <div>
                        <img src="https://i0.wp.com/duesouth.media/wp-content/uploads/2023/02/esme-porch_2947-rotated.jpg?resize=768%2C1024&ssl=1" alt="Cowboy on a porch" class="object-cover w-full h-full">
                    </div>
